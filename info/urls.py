...
from info.views import (
    BlogsDetailView, BlogsListView, BlogsSearchView,
    ExperiencesDetailView, ExperiencesListView,
    ProjectsDetailView, ProjectsListView
)
...
urlpatterns = [
    ...
    path('blogs/search', BlogsSearchView.as_view(), name='blogs-search'),
